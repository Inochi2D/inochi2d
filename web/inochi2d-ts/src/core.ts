...
export type io_sink = {
	error(msg: ptr_t, file: ptr_t, line: number): void;
	warning(msg: ptr_t, file: ptr_t, line: number): void;
...
export abstract class NuObject implements Disposable {
	...
	*/
	...
	// Destructor
	[Symbol.dispose]() {
		__classmap.unregister(this.ptr_);
	}
...
*/
export function nu_malloc(bytes: number): ptr_t {
	return __inochi2d.exports.nu_malloc(bytes);
}
...
/**
	...
	@returns {ptr_t} A pointer to the new memory allocation.
*/
export function nu_realloc(ptr: ptr_t, bytes: number): ptr_t {
	return __inochi2d.exports.nu_realloc(ptr, bytes);
}
...
*/
export function nu_free(ptr: ptr_t): void {
	__inochi2d.exports.nu_free(ptr);
}
...
/**
	...
	Inochi2D type.
*/
export function in_retain(ptr: ptr_t): ptr_t {
	return __inochi2d.exports.in_retain(ptr);
}
...
/**
	...
	Inochi2D type.
*/
export function in_release(ptr: ptr_t): ptr_t {
	return __inochi2d.exports.in_release(ptr);
}
...
/**
	Frees a puppet.
*/
export function in_puppet_free(ptr: ptr_t): void {
	__inochi2d.exports.in_puppet_free(ptr);
}

/**
	Gets the name of a puppet.
*/
export function in_puppet_get_name(ptr: ptr_t): string {
	return ldstr(__inochi2d.exports.in_puppet_get_name(ptr));
}

/**
	Gets the author of a puppet.
*/
export function in_puppet_get_author(ptr: ptr_t): string {
	return ldstr(__inochi2d.exports.in_puppet_get_author(ptr));
}
...
*/
export function in_puppet_get_gravity(ptr: ptr_t): number {
	return __inochi2d.exports.in_puppet_get_gravity(ptr);
}
...
/**
    Updates a puppet.
*/
export function in_puppet_update(ptr: ptr_t, delta: number): void {
	__inochi2d.exports.in_puppet_update(ptr, delta);
}

/**
    Draws a puppet.
*/
export function in_puppet_draw(ptr: ptr_t, delta: number): void {
	__inochi2d.exports.in_puppet_draw(ptr, delta);
}

/**
	Resets the drivers of a puppet.
*/
export function in_puppet_reset_drivers(ptr: ptr_t): void {
	__inochi2d.exports.in_puppet_reset_drivers(ptr);
}
...
*/
export function in_puppet_get_drawlist(ptr: ptr_t): ptr_t {
	return __inochi2d.exports.in_puppet_get_drawlist(ptr);
}

/**
	Gets the root node of a puppet.
*/
export function in_puppet_get_root_node(ptr: ptr_t): ptr_t {
	return __inochi2d.exports.in_puppet_get_root_node(ptr);
}
...
*/
export function in_node_new(ptr: ptr_t): ptr_t {
	return __inochi2d.exports.in_node_new(ptr);
}

/**
	Gets the given node's parent puppet.
*/
export function in_node_get_puppet(ptr: ptr_t): ptr_t {
	return __inochi2d.exports.in_node_get_puppet(ptr);
}

/**
	Gets the given node's parent node.
*/
export function in_node_get_parent(ptr: ptr_t): ptr_t {
	return __inochi2d.exports.in_node_get_parent(ptr);
}
...
*/
export function in_node_get_name(ptr: ptr_t): string {
	return ldstr(__inochi2d.exports.in_node_get_name(ptr));
}

/**
	Gets the name of the given node's type.
*/
export function in_node_get_type(ptr: ptr_t): string {
	return ldstr(__inochi2d.exports.in_node_get_type(ptr));
}

/**
	Gets the z sorting value for the node.
*/
export function in_node_get_zsort(ptr: ptr_t): number {
	return __inochi2d.exports.in_node_get_zsort(ptr);
}

/**
	Gets the tree depth of the node.
*/
export function in_node_get_tree_depth(ptr: ptr_t): number {
	return __inochi2d.exports.in_node_get_tree_depth(ptr);
}

/**
	Gets whether the node is enabled.
*/
export function in_node_get_enabled(ptr: ptr_t): boolean {
	return __inochi2d.exports.in_node_get_enabled(ptr);
}
...
export function ptrextract<T extends NuObject>(ptr: ptr_t, count: number, CT: new(...args: any[]) => T): Array<T | null> {
...
function stu8(ptr: ptr_t, value: number): void { (new DataView(__inochi2d.exports.memory.buffer)).setUint8(ptr, value); }
function sti16(ptr: ptr_t, value: number): void { (new DataView(__inochi2d.exports.memory.buffer)).setInt16(ptr, value, true); }
function stu16(ptr: ptr_t, value: number): void { (new DataView(__inochi2d.exports.memory.buffer)).setUint16(ptr, value, true); }
function sti32(ptr: ptr_t, value: number): void { (new DataView(__inochi2d.exports.memory.buffer)).setInt32(ptr, value, true); }
function stu32(ptr: ptr_t, value: number): void { (new DataView(__inochi2d.exports.memory.buffer)).setUint32(ptr, value, true); }
function stf32(ptr: ptr_t, value: number): void { (new DataView(__inochi2d.exports.memory.buffer)).setFloat32(ptr, value, true); }
