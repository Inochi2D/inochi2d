...
class Node extends NuRefCounted {
	...
	*/
	public hasProperty(key: string): boolean {
		return in_node_has_property(this.ptr, key);
	}
	...
	*/
	public getProperty(key: string): number {
		return in_node_get_property(this.ptr, key);
	}
	...
	*/
	public getPropertyDefault(key: string): number {
		return in_node_get_property_default(this.ptr, key);
	}
	...
	*/
	public setProperty(key: string, value: number): void {
		in_node_set_property(this.ptr, key, value);
	}
}
